...
transformed using AWS SAM [https://github.com/nholuongut/aws-serverless-jenkins-terraform-module](https://github.com/nholuongut/aws-serverless-jenkins-terraform-module) before the linter processes the template.
...
```yaml
repos:
-   repo: https://github.com/nholuongut/cloudformation-python-linter
...
* You can see available cfn-lint versions on the [releases page](https://github.com/nholuongut/cloudformation-python-linter/releases).
