            ...
            'results': [
                {
                    ...
                    'Rule': {
                        ...
                        'Source': 'https://github.com/nholuongut/cloudformation-python-linter/blob/master/docs/cfn-resource-specification.md#properties'
                    }
                },
                {
                    'Filename': 'test/fixtures/templates/bad/core/directives.yaml',
                ...
                },
                {
                    ...
                    'Rule': {
                        ...
                        'Source': 'https://github.com/nholuongut/cloudformation-python-linter'
                    }
                },
                {
                    'Filename': 'test/fixtures/templates/bad/core/directives.yaml',
                ...
                },
                {
                    ...
                    'Rule': {
                        ...
                        'Source': 'https://github.com/nholuongut/cloudformation-python-linter/blob/master/docs/cfn-resource-specification.md#allowedvalue'
                    }
                }
            ]
        }
