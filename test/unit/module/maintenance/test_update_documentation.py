    ...
    def test_update_iam_policies(self):
        ...
        with patch('{}.open'.format(builtin_module_name), mo) as mock_builtin_open:
            ...
            expected_calls = [
                ...
                call(
                    '| E1000<a name="E1000"></a> | Test Error | Test Description |  | [Source](https://github.com/nholuongut/cloudformation-python-linter/) | `resources` |\n'),
                call(
                    '| W1001<a name="W1001"></a> | Test Warning | Test Description |  | [Source](https://github.com/nholuongut/cloudformation-python-linter/) | `resources`,`iam` |\n'),
                call('### Experimental rules\n'),
                call('| Rule ID  | Title | Description | Source | Tags |\n'),
                call('| -------- | ----- | ----------- | ------ | ---- |\n'),
                call(
                    '| E1001<a name="E1001"></a> | Test Expiremental | Test Description |  | [Source](https://github.com/nholuongut/cloudformation-python-linter/) | `resources` |\n'),
            ]
